...
copy_required "${SOURCE_ROOT}/python/boss_recruiting_pipeline_flow.py" "${staging}/python/"
copy_required "${SOURCE_ROOT}/python/candidate_evaluator.py" "${staging}/python/"
copy_required "${SOURCE_ROOT}/python/import_run_sqlite.py" "${staging}/python/"
copy_required "${SOURCE_ROOT}/python/talent_store.py" "${staging}/python/"
