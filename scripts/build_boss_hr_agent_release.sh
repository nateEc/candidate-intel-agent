...
cp python/boss_recruiting_pipeline_flow.py "${PACKAGE_ROOT}/python/"
cp python/candidate_evaluator.py "${PACKAGE_ROOT}/python/"
cp python/import_run_sqlite.py "${PACKAGE_ROOT}/python/"
cp python/talent_store.py "${PACKAGE_ROOT}/python/"
